...
AGENTS = [
    {
        "name":          "chart_analyst",
        "description":   "ניתוח גרפי TradingView, vision, תמונת מסך, זיהוי תבניות ויזואליות",
        "supports_image": True,
        "active":        True,
        "contexts":      ["SHORT_TERM", "LONG_TERM"],
        "extra_fields":  ["trade_type"],   # שדות נוספים שה-router יחזיר
    },
    {
        "name":          "short_term",
        "description":   "סווינג, טווח קצר, 6 חוקי מיכה, CCI, SMA20, ניתוח נרות",
    ...
    {
        "name":          "long_term",
        "description":   "ניתוח מבני, תמיכות, התנגדויות, מגמה ראשית, טווח ארוך",
        "supports_image": False,
        "active":        True,
        "contexts":      ["LONG_TERM"],
        "extra_fields":  [],
...
# שמות סוכנים תקינים (פעילים בלבד)
